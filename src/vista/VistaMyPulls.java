...
public final class VistaMyPulls extends JFrame {

	private static final VistaMyPulls vmp = new VistaMyPulls();
	 ...
	 */
	public static VistaMyPulls getVmp() {
		return vmp;
	}
